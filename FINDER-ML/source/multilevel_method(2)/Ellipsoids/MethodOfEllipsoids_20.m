function parameters = MethodOfEllipsoids_20(Datas, parameters, methods)
...
parameters = plotHeatMap1(WrongPoints2, SepCrit, parameters);
...
function [wrong, wrong2, sc] = IdentifyMisplaced(Datas, parameters, iFeatures)
        ...
        for C = 'AB'
            ...
            for D = 'AB'         
                ...
                iInside('AB' == D,:) = sum(Y.^2,1) <= E.(D).radius;
