function [Datas, parameters] = SelectNoisyACALFeatures(Datas, parameters, methods)
%close all

[Datas,~] = ResidSubspace3(Datas, parameters, methods);
...
if numNoisy == 0
    thresh = thresh - 0.2;
    if thresh <= 0
        NoisyFeatures = 1:size(Datas.A.CovTraining,1);
