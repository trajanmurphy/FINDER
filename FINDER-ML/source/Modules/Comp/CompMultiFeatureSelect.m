function results = CompMultiFeatureSelect(Datas, parameters, methods, results)
...
if parameters.parallel.on
    ...
    parfor i = parameters.data.NAvals
     %for i = 1:parameters.data.NAvals
        ...
        array(i,:,:,:,:) = methods.Multi2.FeatureSelectSub(Datas, parameters2, methods, results);
    end
...
elseif ~parameters.parallel.on
    for i = parameters.data.NAvals
        parameters.data.i = i;
        fprintf('Testing Batch %d of %d\n', i, I);
        array(i,:,:,:,:) = methods.Multi2.FeatureSelectSub(Datas, parameters, methods, results);
    end
