...
% K1 = cellfun( @(i) sparse(K(:,i)), 1:sub1.M-1, 'UniformOutput', false);
% K2 = cellfun( @(i) sparse(K(:,i)), 2:sub1.M, 'UniformOutput', false);
% G2 = [-K1 ; sparse(sub1.P, sub1.M)] + [sparse(sub1.P, sub1.M) ; K2];
